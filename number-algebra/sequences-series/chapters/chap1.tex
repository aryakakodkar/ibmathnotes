...
\begin{questions}
  \begin{multicols}{2}
    \begin{enumerate}[label=\alph*), itemsep=1ex]
      ...
      \begin{enumerate}[label=\roman*)]
        ...
        \item $1, \frac{1}{4}, \frac{1}{9}, \frac{1}{16}, \ldots$
      ...
      \begin{enumerate}[label=\roman*)]
        \item $\sum_{i=1}^{7} 2i$
        \item $\sum_{i=1}^{5} 3^i$
        \item $\sum_{i=1}^{12} \frac{1}{i^2}$
        \item $\sum_{i=1}^{8} i^2 + 5$
      \end{enumerate}
    \end{enumerate}
  \end{multicols}
  ...
  \begin{multicols}{2}
    \begin{enumerate}[label=\alph*), itemsep=1ex, start=3]
      ...
      \item Consider the sequence defined by the formula $u_n = 3n^2 + 2n - 1$. Find the first five terms of the sequence and determine whether it is arithmetic, geometric, or neither.
    \end{enumerate}
  \end{multicols}
