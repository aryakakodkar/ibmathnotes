...
\begin{questions}
	...
	\begin{multicols}{2}
		\begin{enumerate}[label=\alph*), itemsep=1ex]
			\item Consider the arithmetic sequence where the first term is $7$ and the common difference is $5$. Find:
			\begin{enumerate}[label=\roman*)]
				\item The 15th term.
				\item The general formula for the $n$th term.
				\item The sum of the first 12 terms.
			\end{enumerate}

			\item An arithmetic sequence has $u_4 = 22$ and $u_{10} = 64$. Find:
			\begin{enumerate}[label=\roman*)]
				\item The first term and common difference.
				\item The general formula for the $n$th term.
				\item The sum of the first 15 terms.
			\end{enumerate}
		\end{enumerate}
	\end{multicols}
	...
	\begin{multicols}{2}
		\begin{enumerate}[label=\alph*), itemsep=1ex, start=3]
			\item In an arithmetic sequence, the sum of the first three terms is $45$, and the sum of the next three terms is $81$. Find:
			\begin{enumerate}[label=\roman*)]
				\item The first term and common difference.
				\item The general formula for the $n$th term.
				\item The sum of the first 20 terms.
				\item The term of the sequence which is equal to 119.
			\end{enumerate}

			\item A company offers a starting salary of \$50,000 with an annual increase of \$3,500. Find:
			\begin{enumerate}[label=\roman*)]
				\item The salary in the 10th year.
				\item The general formula for the salary in the $n$th year.
				\item The total salary earned over the first 15 years.
			\end{enumerate}
		\end{enumerate}
	\end{multicols}

	% final single-column question
	\begin{enumerate}[label=\alph*), itemsep=1ex, start=5]
		\item It is known that the sum of the first $n$ terms of an arithmetic sequence is given by $S_n = 3n^2 + 2n$. Find:
		\begin{enumerate}[label=\roman*)]
			\item The first term and common difference.
			\item The general formula for the $n$th term.
			\item The 15th term.
