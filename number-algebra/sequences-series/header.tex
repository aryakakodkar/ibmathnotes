...
\declaretheoremstyle[
	headfont=\bfseries\sffamily\color{white}, bodyfont=\normalfont\color{white},
	mdframed={
			linewidth=2pt,
			rightline=false, topline=false, bottomline=false,
			linecolor=Cerulean, backgroundcolor=Cerulean,
			nobreak=false
		}
]{thmred3box}

\declaretheoremstyle[
	headfont=\bfseries\sffamily\color{Cerulean!8}, bodyfont=\normalfont\color{Black},
	numbered=no,
\mdframed={
		linewidth=2pt,
		rightline=false, topline=false, bottomline=false,
		linecolor=Cerulean, backgroundcolor=Cerulean!4,
		nobreak=false,
		skipabove=6pt
	}
]{thmred4box}
...
% Exercises environment (plural) - declared here so \begin{exercises} works
\declaretheorem[style=thmred3box, name=Exercises, numberwithin=chapter]{exercises}
% questions: no visible heading, use a plain mdframed box and add space above
\newenvironment{questions}[1][]{%
	\vspace{-10pt}% space between preceding text and the questions box
	\begin{mdframed}[linewidth=2pt,rightline=false,topline=false,bottomline=false,
		linecolor=Cerulean,backgroundcolor=Cerulean!4,innertopmargin=12pt,innerbottommargin=4pt]
}{%
	\end{mdframed}
}
...
\declaretheorem[style=thmexplanationbox, numbered=no, name=Explanation]{tmpexplanation}
